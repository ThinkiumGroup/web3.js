...
var cipher = require('../lib/utils/cipher');
    ...
    describe('event', function () {
        ...
        it('should call constant function', function () {
            ...
            provider.injectValidation(function (payload) {
                ...
                assert.deepEqual(payload.params, [{
                    data: '0x' + cipher.hash256(signature).slice(0, 8) + '0000000000000000000000001234567890123456789012345678901234567891',
                    to: address
                }, 'latest']);
            });
        ...
        it('should sendTransaction to contract function', function () {
            ...
            provider.injectValidation(function (payload) {
                ...
                assert.deepEqual(payload.params, [{
                    data: '0x' + cipher.hash256(signature).slice(0, 8) +
